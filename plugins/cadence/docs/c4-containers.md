...
C4Container
  ...
  System_Boundary(cadence, "cadence Plugin") {
    ...
    Container(skills, "Skills & Agents", "Markdown instruction files", "using-cadence routing; phase agents (clarify, analyze-problem, plan, implement, review, deliver); utility subagents (probe, check, verify, code-review)")
