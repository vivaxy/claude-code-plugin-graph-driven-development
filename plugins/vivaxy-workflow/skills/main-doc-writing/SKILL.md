---
name: vivaxy-workflow:main:doc-writing
...
Use the clarification summary from the current conversation context to understand what document is being written, its audience, scope, and success criteria. If no clarification has been established yet, invoke `vivaxy-workflow:main:clarify` first.
