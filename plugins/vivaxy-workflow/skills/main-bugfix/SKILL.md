---
name: vivaxy-workflow:main:bugfix
...
Use the clarification summary from the current conversation context to understand the bug's scope, constraints, and success criteria. If no clarification has been established yet, invoke `vivaxy-workflow:main:clarify` first.
